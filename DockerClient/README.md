...
-------------------------------------------------------------------------------------------------------------------------------------------
Alternative steps on windows
-------------------------------------------------------------------------------------------------------------------------------------------
1)Make DockerClient as current directory in windows command line.
2)Run "docker build -t dockit ." --> You can change the name of image from dockit to anything else you prefer
3)Run "docker run -it ." This will run the docker image just build. This image tries to test a REST service. The service is in Service folder.
Start the service before you run the docker as client.
